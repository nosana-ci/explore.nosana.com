<template>
  ...
  <div class="box is-borderless">
    ...
    <div class="p-5 deployment-header">
        <div class="is-flex is-justify-content-space-between is-align-items-start">
          ...
          <!-- Actions Dropdown removed - no authentication in explorer mode -->
        </div>
      </div>
    </div>
    ...
    <div class="p-5">
      ...
      <!-- Container Controls and System Logs tabs removed - require authentication -->
  ...
  <!-- Modals, logs, and chat removed - not available in explorer mode -->
</template>
...
// FLog types removed - not used in explorer mode
...
// Job tabs and progress bar interfaces removed - not used in explorer mode
...
// Check if job has a real node (not a placeholder)
...
// Job action functions removed - no authentication in explorer mode
...
// OpenAI endpoint detection removed - not needed in explorer mode

// FLogs and chat functionality removed - not available in explorer mode
...
// Action dropdown functionality removed - no authentication in explorer mode
...
// Click outside handler removed - no dropdown in explorer mode
</script>
